#define PROBLEM "https://atcoder.jp/contests/arc065/tasks/arc065_d"
...
int main() {
  ...
  rep(i, n) {
    int root1 = roads.root(i);
    int root2 = rails.root(i);

    root_pair_count[pair(root1, root2)]++;
  }
  ...
  rep(i, n) {
    ...
    answers[i] = root_pair_count[pair(root1, root2)];
  }
