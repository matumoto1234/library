...
data:
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/arc065/tasks/arc065_d\"\n\n\
    ...
    \ q;\n\n    p--, q--;\n\n    roads.merge(p, q);\n  }\n\n  UnionFind rails(n);\n\
    \n  rep(_, l) {\n    int r, s;\n    cin >> r >> s;\n\n    r--, s--;\n\n    rails.merge(r,\
    \ s);\n  }\n\n\n  map<pii, int> root_pair_count;\n  rep(i, n) {\n    int root1\
    \ = roads.root(i);\n    int root2 = rails.root(i);\n\n    root_pair_count[pair(root1,\
    \ root2)]++;\n  }\n\n  vector<int> answers(n);\n  rep(i, n) {\n    int root1 =\
    \ roads.root(i);\n    int root2 = rails.root(i);\n\n    answers[i] = root_pair_count[pair(root1,\
    \ root2)];\n  }\n\n  cout << answers << endl;\n}\n"
  dependsOn: []
  ...
  verifiedWith: []
documentation_of: test/atcoder/arc/arc065/D.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/arc/arc065/D.test.cpp
- /verify/test/atcoder/arc/arc065/D.test.cpp.html
