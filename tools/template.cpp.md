...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tools/template.cpp\"\n#include <bits/stdc++.h>\nusing namespace\
  ...
  code: "#include <bits/stdc++.h>\nusing namespace std;\n\n// {{{ Templates\n\n//\
    ...
    #define rep(...) over_load_(__VA_ARGS__, rep4, rep3, rep2)(__VA_ARGS__)\n#define\
    \ rep2(i, r) for ( int i = 0; i < static_cast<int>(r); (i) += 1)\n#define rep3(i,\
    \ l, r) for ( int i = static_cast<int>(l); i < static_cast<int>(r); (i) += 1)\n\
    #define rep4(i, l, r, stride) for ( int i = static_cast<int>(l); i < static_cast<int>(r);\
  ...
  verifiedWith: []
documentation_of: tools/template.cpp
layout: document
redirect_from:
- /library/tools/template.cpp
- /library/tools/template.cpp.html
